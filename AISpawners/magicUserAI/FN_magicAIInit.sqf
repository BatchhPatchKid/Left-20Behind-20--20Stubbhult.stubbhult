...
_unit setVariable ["ritualStatusPig", if (_discipline isEqualTo "pig") then {60} else {0}, true];
_unit setVariable ["ritualStatusZeus", if (_discipline isEqualTo "greek") then {60} else {0}, true];
_unit setVariable ["ritualStatusWanderer", if (_discipline isEqualTo "wanderer") then {60} else {0}, true];
