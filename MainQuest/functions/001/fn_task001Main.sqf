...
switch (_mode) do {
    ...
    case "playDialogueLocal": {
        ...
        private _lines = [
            ["Player", "Hello Contractor, I need to establish contact with PMC Group Alpha asap, can you assist with this?", 0, 6],
            ["Trader", "Bro what? Who just barges in a Contractor Office demanding something like that? You want me to get the president on the phone while I’m at it? No, I can’t do that. Not at least for free.", 1, 9],
