...
while {true} do {
    while {alive player} do {
        ...
        private _scalar = [player] call FN_getScalar;
        // Base hydration decrease is 0.75 point per cycle.
        private _baseHydrationDecrease = 0.75;
        ...
        // Nutrition decreases every 3 minutes (0.65 per 30s cycle)
        private _baseNutritionDecrease = 0.65;
