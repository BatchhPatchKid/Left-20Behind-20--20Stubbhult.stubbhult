...
private _ambient = createHashMapFromArray [
    ...
    ["US", [
        [
            ...
            ["LEADER", "Hmm, no excuse then. You now have KP every day for the next five days. Your shifts are evening and morning. Be at the KP tent one hour prior.", 5.0, 7.0],
            ["RANDOM", "Roger, Sar'nt...", 5.0, 7.0]
        ]
    ]],
    ...
    ["RU", [
        [
            ...
            ["RANDOM", "Yes, Yefreytor, I would never leave it behind.", 5.0, 7.0],
            ["LEADER", "Good, another from our team left his back at base. I haven't seen him since we left the FOB.", 5.0, 7.0],
            ["RANDOM", "Aleksandr has always been a fool. That's the last thing one of us should forget...", 5.0, 7.0]
        ]
    ]],
    ...
    ["PMC", [
        [
            ...
            ["RANDOM", "Affirmative sir, most of the team has signs of acute radiation poisoning, trench foot, minor frostbite, and vitamin D deficiency.", 5.0, 7.0],
            ["LEADER", "Yes, those were all expected, but the footnotes in the report piqued my interest, Gustave. What do you mean, 'mystery illness'?", 5.0, 7.0],
            ...
            ["RANDOM", "For this reason, sir, I believe we should exfil immediately for the wellbeing of our company. In my unofficial opinion, sir, this island just isn't right.", 5.0, 7.0],
    ...
    ["SU", [
        [
            ["LEADER", "Hi Gerard, haven't seen you in a while. How's life been?", 5.0, 7.0],
            ["RANDOM", "It's been great lately. I had my checkup yesterday, and I haven't felt this good since I was eighteen!", 5.0, 7.0],
            ...
            ["LEADER", "Is that right? I'll have to go see the docs soon too. I've been putting off my appointment since I'm afraid of doctors.", 5.0, 7.0],
    ...
    ["TRB", [
        [
            ...
            ["RANDOM", "Yup, they're working me like a dog, but I know it's been difficult for Marshal Peter to send reinforcements.", 5.0, 7.0],
    ...
    ["PF", [
        [
            ...
            ["LEADER", "Just trust the Great Pig, Novice. Its holy power will be on our side for this battle.", 5.0, 7.0]
        ]
    ]],
    ...
    ["Bandit", [
        [
            ...
            ["RANDOM", "Like a heist? Because I'm super down for a big heist of the military base.", 5.0, 7.0],
            ["LEADER", "I heard the lone island in the bay has a lot of treasure. Perhaps they're heading to that island.", 5.0, 7.0],
            ["RANDOM", "True, I've heard that too! We should head there first before anyone else gets there...", 5.0, 7.0]
        ]
    ]],
    ...
    ["BB", [
        [
            ["LEADER", "Yo Bill, long time no see, man! Where have you been?", 5.0, 7.0],
            ...
            ["RANDOM", "It's all The Lion's fault. He put me on his team and we went north. The Pig Flesh aren't normal, man...", 5.0, 7.0],
            ...
            ["RANDOM", "Bob, he started chanting something, and everything in my vision looked like a living hell. The worst things you can imagine came true.", 5.0, 7.0],
    ...
    ["WO", [
        [
            ["LEADER", "Hey Feldwebel, why must we occupy such a deadly area of the island?", 5.0, 7.0],
            ...
            ["LEADER", "Why does the Führer von Bismarck even care about this island? We own most of Germany and France. Is this island really that important?", 5.0, 7.0],
            ["RANDOM", "Apologies, Unteroffizier. Unless I was the Generaloberst, then I might know. All we have are our theories.", 5.0, 7.0],
            ["RANDOM", "That being said, Unteroffizier, it is odd the US Army is occupying parts of this island. There's definitely something strange happening here.", 5.0, 7.0]
        ]
    ]],
    ...
    ["DT", [
        [
            ...
            ["LEADER", "I'll accept that answer since you're just starting out.", 5.0, 7.0],
    ...
    ["NH", [
        [
            ...
            ["RANDOM", "Yeah, I heard their leader came back for some artifact.", 5, 7],
            ["LEADER", "What a bunch of fools, but I can't blame them for being brave.", 5, 7],
            ["RANDOM", "True, if they weren't a bunch of weirdos, I'd respect them a bit more.", 5, 7]
        ],
        [
            ["LEADER", "Have you been catching up on your Greek mythos recently, Bob?", 0.0, 0.0],
            ["RANDOM", "Why the fuck would I do that?", 5, 7],
            ["LEADER", "Deadman's Trident loves asking about that stuff. Ya know they actually believe in Thor and whatnot.", 5, 7],
            ["RANDOM", "That's Norse mythology, you fucking idiot. And no, I haven't been reading Greek stuff.", 5, 7],
            ["LEADER", "Why not? We are technically allied with them.", 5, 7],
            ["RANDOM", "Because their faction is on its last ropes. They keep going out on these 'pilgrimages' to dangerous parts of the island. Most of their experienced members are dead, so all of their newbies haven't been taught shit.", 5, 7],
...
private _combat = createHashMapFromArray [
    ...
    ["ROA", [
		"Alfa-Alfa, echoume echthrikous mi-ethnikous stin periochi, prosvalloume, telos",
		"Alfa-Charlie, dechomaste pyra, mi-ethnikoi epivevaiomenoi, telos",
		"Alfa-Charlie, zitame perissoterous ethnikous gia enischysi, telos",
		"Alfa Actual, echoume ethnikes apoleies se pollous lochous, telos",
		"Alfa-Bravo, zito pyra olmon... break... agnoiste to teleftaio, telos",
		"November 1, edo Alfa-Alfa, poia einai i katastasi sas, telos",
		"November 2, edo Alfa-Alfa, anoixte pyra, telos",
		"November 3, edo Alfa-Alfa, poios einai o arithmos apoleion sas, telos",
		"Alfa Actual, edo November 1, kratame thesi alla dechomaste piesi, telos",
		"Alfa-Alfa, edo November 2, echoume epafi dexia, apostelloume kapno, telos",
		"Alfa Actual, edo Alfa-Delta, zitame amesi diakomidi gia dyo travmaties, telos",
		"November 3, edo Alfa-Alfa, metakinithite sto aristero flango kai prospatheiste yperkerasi, telos",
		"Alfa-Bravo, edo Alfa Actual, egkrinete pyra thanatifora, prochoriste, telos",
		"Alfa-Charlie, edo November 1, ta pyromachika mas einai chamila, zitame ananewsi, telos",
		"Alfa Actual, edo Alfa-Alfa, o tomeas den einai katharos, synechizoume ekkatharisi, telos"
	]],
    ["PMC", [
		"Tango Lima Alpha Actual, this is Alpha-Oscar 6, enemy contact, engaging, over",
		"Tango Lima Alpha Actual, this is Alpha-Oscar 6, reinforcement requested, over... Affirmative, over",
		"Alpha-Oscar 10, Alpha-Oscar 11, Alpha-Oscar 12, engage designated target, over",
		"Alpha-Oscar 10, requesting 9-line, over",
		"Tango Lima Alpha-3 Actual, requesting gun run, over... Affirmative, over",
		"Tango Lima Alpha-3 Actual, requesting permission for lethal fire, over",
		"Alpha-Oscar 10, this is Alpha-Oscar 7, move left and take flank, over",
		"Tango Lima Alpha Actual, this is Alpha-Oscar 2, contact front, 200 meters, requesting permission to engage, over",
		"Tango Lima Alpha Actual, be advised, Objective Bravo reached, security established, over",
		"Alpha-Oscar 10, move to Phase Line Red, hold position, over",
		"Alpha-Oscar 7, suppressing Building Two, marking with smoke, over",
		"Tango Lima Alpha-3 Actual, this is Alpha-Oscar 6, Oscar Mike to Lima Zulu, ETA two mikes, over",
		"Tango Lima Alpha Actual, this is Alpha-Oscar 6, status green, ammo yellow, continuing mission, over",
		"Alpha-Oscar 11, check fire, friendlies danger close, wait one, over",
		"Tango Lima Alpha Actual, this is Alpha-Oscar 7, taking accurate fire, requesting smoke, bounding left, over"
    ]],
    ["SU", ["We got strays!",
    ...
    ["Bandit", ["Kill em' and take their shit!",
        ...
        "Time to die!",
		"You fucking bastard, come here you piece of dogshit, you want to come at me you smelly fucking asshole? Come on try to fuck me up, I’ll fuck you up myself you motherfucker, you goddamn wanker. GO TO HELL, come on idiot, ill fuck you and your entire family up. FUCKING DOGSHIT you STENCHING SLOB, you turd, bitch, bastard, COME HERE you scoundrel, scum, shitstiain COME HERE you FUCKING ASSHOLE."
    ]],
